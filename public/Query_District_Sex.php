...
<html>
	<head>
		<title>District Wise & Sex Wise Distribution Of Queries Asked For Employee Of Diferent Categories</title>
		<link href="stylesheets/public.css" media="all" rel="stylesheet" type="text/css"/>
		<script type="text/javascript" src="javascripts/Javascript.js"></script>
	</head>
	<body id="page">
		<h2>District Wise & Sex Wise Distribution Of Queries Asked For Employee Of Diferent Categories</h2>
		...
		?>
			<tr>
				<th rowspan="3" align="left"><?php echo ucwords($District["district_name"]) ;?></th>
		<?php //****************************************Male (Start)******************************************************?>
		<?php
			$mainquery = "select * 
		...
		?>
				<th align="left"><font size="-2">Male</font></th>
			<?php 
				$Cat=get_all_catg('cat_id');
				while($Category=mysql_fetch_array($Cat)){
					$SubCat=get_sub_catg_for_catg($Category["cat_id"],'cat_master.cat_id,sub_cat_id');
			...
			?>	
									<td colspan="1" rowspan="1" align="right">
										<span title="<?php echo $District["district_name"]."/Male/".catg_name($Category["cat_id"],$SubCategory["sub_cat_id"],$CatDetail["cat_detail_id"]);?>">
										<?php //echo $Category["cat_id"].".".$SubCategory["sub_cat_id"].".".$CatDetail["cat_detail_id"] ;?>
										<?php 
										$query = $mainquery." and gender = 'Male' 
			...
			?>			
								<td colspan="1" rowspan="1" align="right">
									<span title="<?php echo $District["district_name"]."/Male/".catg_name($Category["cat_id"],$SubCategory["sub_cat_id"],0);?>">
			...
			?>		
						<td colspan="1" rowspan="1" align="right">
							<span title="<?php echo $District["district_name"]."/Male/".catg_name($Category["cat_id"],0,0);?>">
			...
			<?php	}
				...
				<td colspan="1" rowspan="1" align="right">
					<span title="<?php echo $District["district_name"]."/Male/Total";?>">
					<?php 
					$query = $mainquery." and gender = 'Male' 
								order by issue_id";
					$issue=mysql_query($query,$conn);
		...
		<?php
			$mainquery = "select * 
					...
					where district='".$District["district_id"]."' ";
		?>
				<th align="left"><font size="-2">Female</font></th>
			<?php 
				$Cat=get_all_catg('cat_id');
				while($Category=mysql_fetch_array($Cat)){
					$SubCat=get_sub_catg_for_catg($Category["cat_id"],'cat_master.cat_id,sub_cat_id');
			...
			?>	
									<td colspan="1" rowspan="1" align="right">
										<span title="<?php echo $District["district_name"]."/Female/".catg_name($Category["cat_id"],$SubCategory["sub_cat_id"],$CatDetail["cat_detail_id"]);?>">
										<?php //echo $Category["cat_id"].".".$SubCategory["sub_cat_id"].".".$CatDetail["cat_detail_id"] ;?>
										<?php 
										$query = $mainquery." and gender = 'Female' 
													and cat_id='".$Category["cat_id"]."' and sub_cat_id='".$SubCategory["sub_cat_id"]."'
													and cat_detail_id='".$CatDetail["cat_detail_id"]."'
													order by issue_id";
										$issue=mysql_query($query,$conn);
			...
			?>			
								<td colspan="1" rowspan="1" align="right">
									<span title="<?php echo $District["district_name"]."/Female/".catg_name($Category["cat_id"],$SubCategory["sub_cat_id"],0);?>">
									<?php //echo $Category["cat_id"].".".$SubCategory["sub_cat_id"].".0" ;?>
									<?php 
									$query = $mainquery." and gender = 'Female' 
												and cat_id='".$Category["cat_id"]."' and sub_cat_id='".$SubCategory["sub_cat_id"]."'
			...
			?>		
						<td colspan="1" rowspan="1" align="right">
							<span title="<?php echo $District["district_name"]."/Female/".catg_name($Category["cat_id"],0,0);?>">
							<?php //echo $Category["cat_id"].".0.0" ;?>
							<?php 
							$query = $mainquery." and gender = 'Female' 
										and cat_id='".$Category["cat_id"]."' 
			...
			<?php	}
				...
				<td colspan="1" rowspan="1" align="right">
					<span title="<?php echo $District["district_name"]."/Female/Total";?>">
					<?php 
					$query = $mainquery." and gender = 'Female' 
								order by issue_id";
					$issue=mysql_query($query,$conn);
		...
		?>
			...
			?>	
									<td colspan="1" rowspan="1" align="right">
										...
										<?php //echo $Category["cat_id"].".".$SubCategory["sub_cat_id"].".".$CatDetail["cat_detail_id"] ;?>
										<?php 
										$query = $mainquery." and (gender = 'Male' or gender = 'Female') 
													and cat_id='".$Category["cat_id"]."' and sub_cat_id='".$SubCategory["sub_cat_id"]."'
													and cat_detail_id='".$CatDetail["cat_detail_id"]."'
													order by issue_id";
										$issue=mysql_query($query,$conn);
		...
		?>
			...
			?>	
									<td colspan="1" rowspan="1" align="right">
										<span title="<?php echo "Total/Male/".catg_name($Category["cat_id"],$SubCategory["sub_cat_id"],$CatDetail["cat_detail_id"]);?>">
										<?php //echo $Category["cat_id"].".".$SubCategory["sub_cat_id"].".".$CatDetail["cat_detail_id"] ;?>
										<?php 
										$query = $mainquery." and gender = 'Male' 
													and cat_id='".$Category["cat_id"]."' and sub_cat_id='".$SubCategory["sub_cat_id"]."'
			...
			?>			
								<td colspan="1" rowspan="1" align="right">
									<span title="<?php echo "Total/Male/".catg_name($Category["cat_id"],$SubCategory["sub_cat_id"],0);?>">
									<?php //echo $Category["cat_id"].".".$SubCategory["sub_cat_id"].".0" ;?>
									<?php 
									$query = $mainquery." and gender = 'Male' 
												and cat_id='".$Category["cat_id"]."' and sub_cat_id='".$SubCategory["sub_cat_id"]."'
			...
			?>		
						<td colspan="1" rowspan="1" align="right">
							<span title="<?php echo "Total/Male/".catg_name($Category["cat_id"],0,0);?>">
							<?php //echo $Category["cat_id"].".0.0" ;?>
							<?php 
							$query = $mainquery." and gender = 'Male' 
										and cat_id='".$Category["cat_id"]."' 
			...
			<?php	}
				...
				<td colspan="1" rowspan="1" align="right">
					<span title="<?php echo "Total/Male/Total";?>">
					<?php 
					$query = $mainquery." and gender = 'Male' 
								order by issue_id";
					$issue=mysql_query($query,$conn);
		...
		?>
			...
			?>	
									<td colspan="1" rowspan="1" align="right">
										<span title="<?php echo "Total/Female/".catg_name($Category["cat_id"],$SubCategory["sub_cat_id"],$CatDetail["cat_detail_id"]);?>">
										<?php //echo $Category["cat_id"].".".$SubCategory["sub_cat_id"].".".$CatDetail["cat_detail_id"] ;?>
										<?php 
										$query = $mainquery." and gender = 'Female' 
													and cat_id='".$Category["cat_id"]."' and sub_cat_id='".$SubCategory["sub_cat_id"]."'
			...
			?>			
								<td colspan="1" rowspan="1" align="right">
									<span title="<?php echo "Total/Female/".catg_name($Category["cat_id"],$SubCategory["sub_cat_id"],0);?>">
									<?php //echo $Category["cat_id"].".".$SubCategory["sub_cat_id"].".0" ;?>
									<?php 
									$query = $mainquery." and gender = 'Female' 
												and cat_id='".$Category["cat_id"]."' and sub_cat_id='".$SubCategory["sub_cat_id"]."'
			...
			?>		
						<td colspan="1" rowspan="1" align="right">
							<span title="<?php echo "Total/Female/".catg_name($Category["cat_id"],0,0);?>">
							<?php //echo $Category["cat_id"].".0.0" ;?>
							<?php 
							$query = $mainquery." and gender = 'Female' 
										and cat_id='".$Category["cat_id"]."' 
			...
			<?php	}
				...
				<td colspan="1" rowspan="1" align="right">
					<span title="<?php echo "Total/Female/Total";?>">
					<?php 
					$query = $mainquery." and gender = 'Female' 
								order by issue_id";
					$issue=mysql_query($query,$conn);
