...
<html>
	<head>
		<title>Total Query Asked For District Wise & Rank Wise</title>
		<link href="stylesheets/public.css" media="all" rel="stylesheet" type="text/css"/>
		<script type="text/javascript" src="javascripts/Javascript.js"></script>
	</head>
	<body id="page">
		<h2>Total Query Asked For District Wise & Rank Wise</h2>
		<table cellspacing="2" cellpadding="2" border="1" align="center">
			<tr>
				<th rowspan=2>Name of<br />District/<br />Office/<br />Units</th>
				<th rowspan=2>Asked<br />For</th>
				<?php 
			...
			<tr>
				...
				<?php 
					...
					while($Designation=mysql_fetch_array($Desg)){
						$query = "select * 
									from issue_master1 inner join 
									employee_master on person_for like concat(empid,'-%') 
										or person_for like concat(empid,'.%')
									where district='".$District["district_id"]."' 
										and designation='".$Designation["designation_id"]."' 
									order by desc_remark";
						$issue=mysql_query($query,$conn);
