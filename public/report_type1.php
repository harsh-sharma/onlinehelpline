<?php
	...
	$str = "content.php?page=27
			&district=".$district."&designation=".$designation."
			&age=".$age."&gender=".$gender."&cat_id=".$cat_id."
...
?>
	...
	<br>
<table cellspacing="2" cellpadding="2" border="1" align="center" width="95%">
	<tr align="center">
		<th>Sn.&nbsp;</th>
...
?>
		...
		<tr>
			...
			<th><?php echo ucwords($empissue["status"]) ;?>&nbsp;</th>
		</tr>
	<?php }
	}else{?>
		<tr>
...
<br><br>
	...
	<input type="button" name ="Done" value="Done" onclick="PageLoad(document.form1,'content.php?page=18')">
	</form>